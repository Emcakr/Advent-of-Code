public class Pipes {
    ...
    Pipes(String input){
        ...
        connections = new int[lines.length][];

        for (int i = 0; i < lines.length; i++) {
            String[] line = lines[i].split(" ");
            connections[i] = new int[line.length-2];
            for (int j = 0; j < connections[i].length; j++) {
                connections[i][j] = Integer.parseInt(line[j+2]);
            }
    ...
    void traverse(int start){
        ...
        for (int i = 0; i < connections[start].length; i++) {
            if (!connected[connections[start][i]]){
                traverse(connections[start][i]);
            }
        }
    }

    int countGroups(){
        connected = new boolean[connected.length];
    ...
    public static void main(String[] args) {
        Pipes pipes = new Pipes("0 <-> 659, 737\n" +
                "1 <-> 1, 1433\n" +
                "2 <-> 982, 1869\n" +
                "3 <-> 306, 380, 1462, 1827\n" +
                "4 <-> 1076\n" +
        ...
        System.out.println(pipes.countTraversed());
        System.out.println(pipes.countGroups());
    }
}
